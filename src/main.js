    ...
    created(el, binding) {
        ...
        if(binding.arg == undefined || binding.arg === 'simples') {
            funcao = function() {
                ...
                informacaoSpan.style.background = 'red'
